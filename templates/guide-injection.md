...
project-interview, project-plan, project-implement, project-visual-qa, project-verify 가 공통 참조.
...
|------|-------|------|
| service-planner (interview) | -1 — 인터뷰 | architecture-overview, project-layout |
| tech-architect (interview) | -1 — 인터뷰 | architecture-overview, architecture-rules |
